...
//     B::FloatElem: 'static,
    ...
    //  B::IntElem: Into<usize>,
    //  B::IntElem: Into<i32>,
    //  usize: TryInto<i64>,
//     SCBatcher<B>: Batcher<SCItem, SCBatch<B>>,
//     usize: From<<B as Backend>::IntElem>
// where
//     B: Backend<FloatElem = f64, IntElem = i32> + AutodiffBackend + 'static,
//     B::FloatElem: 'static,
//     B::Device: Clone,
//     SCBatcher<B>: Batcher<SCItem, SCBatch<B>>,
//     usize: From<<B as Backend>::IntElem>
{
    // Removed type aliases and use B and Autodiff<B> directly
