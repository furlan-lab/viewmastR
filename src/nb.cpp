...
void naive_bayes_demo_run(std::string lib_path, int perc, bool verbose = false) {
...
//' @export
// [[Rcpp::export]]
void naive_bayes_demo(std::string lib_path, int perc = 80, bool verbose = true) {
  ...
  naive_bayes_demo_run(lib_path, perc, verbose);
  // try {
  //     af::setDevice(0);
  //     af::info();
