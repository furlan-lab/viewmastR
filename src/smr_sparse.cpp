...
// //' @export
// // [[Rcpp::export]]
// af::array smr_sparse_test(RcppArrayFire::typed_array<f32> train_feats,
...
//                      int device = 0) {
// 
//   array train_feats_sp = af::sparse(train_feats.T(), AF_STORAGE_CSR);
// // array test_feats_sp = af::sparse(test_feats, AF_STORAGE_CSR);
// return train_feats_sp;
// }
// 
// 
// //
// //' @export
// // [[Rcpp::export]]
// af::array smr_sparse(RcppArrayFire::typed_array<f32> train_feats,
//                       RcppArrayFire::typed_array<f32> test_feats,
//                       RcppArrayFire::typed_array<s32> train_targets,
//                       RcppArrayFire::typed_array<s32> test_targets,
//                                        int num_classes,
...
// 
// array train_feats_sp = af::sparse(train_feats.T(), AF_STORAGE_CSR);
// array test_feats_sp = af::sparse(test_feats.T(), AF_STORAGE_CSR);
// 
//   try {
//     af::setDevice(device);
...
//   // train_feats_sp = train_feats_sp.T();
//   // test_feats_sp  = test_feats_sp.T();
//   // train_targets = train_targets.T();
//   // test_targets  = test_targets.T();
//   query  = query.T();
...
//   if(verbose){
//     std::cerr << "Train feature dims:" << std::endl;
//     std::cerr << train_feats_sp.dims() << std::endl;
//     std::cerr << "Test feature dims:" << std::endl;
//     std::cerr << test_feats_sp.dims() << std::endl;
//     std::cerr << "Train targets dims:" << std::endl;
//     std::cerr << train_targets.dims() << std::endl;
//     std::cerr << "Test targets dims:" << std::endl;
//     std::cerr << test_targets.dims() << std::endl;
...
//   }
//   // Add a bias that is always 1
//   train_feats = join(1, constant(1, train_feats_sp.dims(0), 1), train_feats_sp);
//   test_feats  = join(1, constant(1, test_feats_sp.dims(0), 1), test_feats_sp);
